...
`returncidr` will, if true, return the calculated IP address in a CIDR
notation with the given CIDR in `prefix`.
...
```
> cidrhost("10.12.112.0/20", 16, false)
10.12.112.16
> cidrhost("10.12.112.0/20", 268, false)
10.12.113.12
> cidrhost("10.12.112.0/20", 16, true)
10.12.112.16/20
> cidrhost("fd00:fd12:3456:7890:00a2::/72", 34, false)
fd00:fd12:3456:7890::22
> cidrhost("fd00:fd12:3456:7890:00a2::/72", 34, true)
fd00:fd12:3456:7890::22/72
```
